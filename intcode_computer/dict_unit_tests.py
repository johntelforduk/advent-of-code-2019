# Unit tests for day 9 of AOC 2019, "Sensor Boost".
...
class TestComputer(unittest.TestCase):
    ...
    def test_input_output(self):
        test_comp = comp.Computer(output_to_screen=False)
        test_comp.load_list([3, 0, 4, 0, 99])                 # This program puts input into address 0, then outputs it.
        test_comp.input = 7
    ...
    def test_jumping(self):
        ...
        # non-zero:
        test_comp1 = comp.Computer(output_to_screen=False)
        test_comp1.load_list([3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9])
        test_comp1.input = 0
        test_comp1.run()
        self.assertEqual(test_comp1.output, 0)
        test_comp2 = comp.Computer(output_to_screen=False)
        test_comp2.load_list([3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9])
    ...
    def test_large_example(self):
        ...
        test_comp1 = comp.Computer(output_to_screen=False)
        test_comp1.load_list([3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31,
    ...
    def test_big_numbers(self):
        ...
        test_comp1.run()
        self.assertEqual(len(str(test_comp1.output)), 16)       # "...should output a 16-digit number."

        test_comp2 = comp.Computer(output_to_screen=False)
        test_comp2.load_list([104, 1125899906842624, 99])
        test_comp2.run()
        self.assertEqual(test_comp2.output, 1125899906842624)   # "...should output the large number in the middle."
